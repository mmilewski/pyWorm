...
ANIMATION = "bang" -- domyślny stan
-- w szczególności może być:  ANIMATION = ""

--       YOFF 0   -- 0 jest domyślnie, więc można pominąć
      FRAME = 128, 128  -- szzerokość i wysokość klatki
      FRAMES = 7        -- 7 klatek w animacji
      COLS = 4          -- klatki są w 4 kolumnach
...
-- kolejność nie ma znaczenia
      ...
      YOFF = 512        -- klatki zaczynają się od 512 piksela od góry
